...
const Modal = ({ open, onClose, children }) => {
    ...
    return (
        ...
        //         <div className='bg-white px-10 py-20 rounded-3xl border-2 border-gray-100 mx-auto w-full max-w-md'>
        //             <h1 className='text-5xl font-semibold'>Welcome Back</h1>
        //             <p className='font-medium text-lg text-gray-500 mt-4'>Welcome Back! Please Enter Your details</p>
        //             <div className='mt-8'>
        //                 <div>
        //                     <label className='text-lg font-medium'>Email</label>
        //                     <input type="email" placeholder='Enter Your email' className='w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent' />
        //                 </div>
        //                 <div>
        ...
        //                         className='ml-2 font-medium text-base text-blue-700' onClick={() => navigate('/signup')}>Sign up</button>
        //                 </div>
