...
const Search = () => {
    const [searchQuery, setSearchgQuery] = useState('')
        ...
        <div className='py-20'>
            <div className='flex justify-center mt-8 flex-col px-5 md:px-20 lg:px-40'>
                <div className='bg-white shadow-lg p-3 rounded-lg mt-[-20px] md:mt-0 mx-auto md:mx-0 max-w-[600px] lg:max-w-[800px] xl:max-w-[1000px] flex items-center'>
                    ...
                    <input type="text" value={searchQuery} placeholder='Search' className='outline-none ml-2 w-full' onChange={(e)=>setSearchgQuery(e.target.value)} />
                </div>
            </div>
        </div>
